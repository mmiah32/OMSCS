...
class QLearner(object):  		  	   		 		  			  		 			     			  	 
    ...
    def query(self, s_prime, r):  		  	   		 		  			  		 			     			  	 
        ...
        q_table_value = self.q_table[self.s, self.a]
        max_row_value = np.max(self.q_table[s_prime])
        updated_value = (1 - self.alpha) * q_table_value + self.alpha * (r + self.gamma * max_row_value)
        self.q_table[self.s, self.a] = updated_value
        self.s = s_prime
